...
with DAG(
    ...
    latest_only = LatestOnlyOperator(task_id="latest_only", dag=dag) #Permet d'executer cette tache uniquement lors du dernier run (derniere date de l'interval) sinon la skip et toutes les autres tache apres
