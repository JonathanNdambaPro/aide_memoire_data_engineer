...
def _fetch_sales(**context):
    """
    Traitenent de deux task en verifiant une condition date
    probleme on ne peut pas voir laquelle s'execute
    ne pas utiliser dans un usecase reel preferer BranchOperator
    """
