...
"""
DAG equivalent au 3 mais plus explicite 
"""
...
with DAG(
    ...
    join_erp = DummyOperator(task_id="join_erp_branch", trigger_rule="none_failed") # Permet de rendre la logique du DAG plus clair pas obligatoire
    ...
    [clean_sales_old, clean_sales_new] >> join_erp # Permet de rendre la logique du DAG plus clair pas obligatoire
